# list-filter Specification

## Purpose
Incremental filtering of the focused list panel: open with `/`, hide non-matching rows as the query is typed, keep the selection and preview coherent with the filtered set, and clear with `esc`.
## Requirements
